...
class nusoap_server extends nusoap_base
{
    ...
    function invoke_method()
    {
        ...
        if ($this->wsdl) {
	        ...
	        //var_dump($this->opData);
                //$this->methodparams = $this->opData['input']['parts'];
//var_dump($this->methodparams); die('peaches');
...
//die('resolve');
            if ( is_array($this->methodparams) && !empty($this->methodparams) ) {
...
//var_dump( $parser );
//var_dump( $parser->root_struct_name );
//die('second that');
        // parser debug
        ...
        if ($err = $parser->getError()) {
            ...
            //var_dump($parser->get_soapbody() ); die('fin');
