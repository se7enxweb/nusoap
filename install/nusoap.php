...
$uri = eZURI::instance( (string)$_SERVER['REQUEST_URI'] );

// echo eZSys::requestURI();
...
$serviceIdentifier = $uri->element(1);
...
//var_dump( $serviceIdentifier); //die();
/*
var_dump( $serviceIdentifier); //die();
var_dump(eZSys::requestURI());die();
var_dump($uri->elements(false)); die('poop');
*/
